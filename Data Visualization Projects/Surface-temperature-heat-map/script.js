...
.then(data => {
    ...
    .attr('x', (d, i) => i * 3.43)
    .attr('transform', 'translate(130, 45.5)')
    .append('title')
    .text(d => {
        countJan++;
    ...
    .attr('x', (d, i) => i * 3.43)
    .attr('transform', 'translate(130, 86.5)')
    .append('title')
    .text(d => {
        countDec++;
    ...
    .attr('x', (d, i) => i * 3.43)
    .attr('transform', 'translate(130, 128)')
    .append('title')
    .text(d => {
        countNov++;
    ...
    .attr('x', (d, i) => i * 3.43)
    .attr('transform', 'translate(130, 169.6)')
    .append('title')
    .text(d => {
        countOct++;
    ...
    .attr('x', (d, i) => i * 3.43)
    .attr('transform', 'translate(130, 211.2)')
    .append('title')
    .text(d => {
        countSep++;
    ...
    .attr('x', (d, i) => i * 3.43)
    .attr('transform', 'translate(130, 252.8)')
    .append('title')
    .text(d => {
        countAug++;
    ...
    .attr('x', (d, i) => i * 3.43)
    .attr('transform', 'translate(130, 294.4)')
    .append('title')
    .text(d => {
        countJly++;
    ...
    .attr('x', (d, i) => i * 3.43)
    .attr('transform', 'translate(130, 337.4)')
    .append('title')
    .text(d => {
        countJun++;
    ...
    .attr('x', (d, i) => i * 3.43)
    .attr('transform', 'translate(130, 379)')
    .append('title')
    .text(d => {
        countMay++;
    ...
    .attr('x', (d, i) => i * 3.43)
    .attr('transform', 'translate(130, 420.6)')
    .append('title')
    .text(d => {
        countApr++;
    ...
    .attr('x', (d, i) => i * 3.43)
    .attr('transform', 'translate(130, 461.8)')
    .append('title')
    .text(d => {
        countMar++;
    ...
    .attr('x', (d, i) => i * 3.43)
    .attr('transform', 'translate(130, 500.8)')
    .append('title')
    .text(d => {
        countFeb++;
    ...
    svg.append('g')
    .attr('transform', 'translate(130, 38)')
    .attr('id', 'x-axis')
    ...
    svg.append('g')
    .attr('transform', 'translate(130, 538)')
    .attr('id', 'y-axis')
    ...
    svg.append('g')
    .attr('transform', 'translate(150, 632)')
    .attr('id', 'key')
    ...
    .enter()
    .append('rect')
    .attr('transform', 'translate(149.5, 609.5)')
    .attr('width', 33.4)
    .attr('class', d => {
        switch (d) {
